...
const Search = ({ open, setOpen }: any) => {
  return (
    <>
      <div className={`search__popup ${open ? "search-opened" : ""}`}>
              ...
              <div className="search__wrapper">
                <div className="search__top d-flex justify-content-between align-items-center">
                  ...
                  <div className="search__close">
                    <button onClick={() => setOpen(false)} type="button" className="search__close-btn search-close-btn">
      ...
      <div className={`body-overlay ${open ? "apply" : ""}`} onClick={() => setOpen(false)} style={{ cursor: "pointer" }}></div>
